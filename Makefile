...
# --- SOURCE FILES
PROJECTDIRS+=src src/config src/connection src/connection/beacon src/etc src/tool src/node/controller src/node/forwarder src/node/sensor
PROJECT_SOURCEFILES+=config.c connection.c beacon.c etc.c simple-energest.c controller.c forwarder.c sensor.c
